...
<div id="detailsTaskModal-{{ $t->id }}" class="modal">
  <div class="modal-content">
    ...
    <p><strong>Utworzono:</strong> {{ $t->created_at->timezone('Europe/Warsaw')->format('d.m.Y H:i') }}</p>
    <p><strong>Ostatnia aktualizacja:</strong> {{ $t->updated_at->timezone('Europe/Warsaw')->format('d.m.Y H:i') }}</p>
  </div>
</div>
@endforeach
  ...
  <table>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td>{{ $h->updated_at->timezone('Europe/Warsaw')->format('d.m.Y H:i') }}</td>
        <td>
...
<div id="detailsTaskModal-{{ $h->id }}" class="modal">
  <div class="modal-content">
    ...
    <p><strong>Utworzono:</strong> {{ $h->created_at->timezone('Europe/Warsaw')->format('d.m.Y H:i') }}</p>
    <p><strong>Ukończono:</strong> {{ $h->updated_at->timezone('Europe/Warsaw')->format('d.m.Y H:i') }}</p>
  </div>
</div>
@endforeach
