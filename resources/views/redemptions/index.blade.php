          ...
          <tbody>
            @foreach($redemptions as $r)
              <tr>
                ...
                <td>
                  <span style="display: inline-block; padding: 0.25rem 0.75rem; border-radius: 30px; background: #25262B;">
                    @if($r->status == 'pending')
                      <i class="fa-solid fa-clock" style="color: #FFA000; margin-right: 0.25rem;"></i> Oczekuje
                    @elseif($r->status == 'approved')
                      <i class="fa-solid fa-check-circle" style="color: #4CAF50; margin-right: 0.25rem;"></i> Zatwierdzono
                    @else
                      <i class="fa-solid fa-times-circle" style="color: #f44336; margin-right: 0.25rem;"></i> Odrzucono
                    @endif
                  </span>
                </td>
              </tr>
